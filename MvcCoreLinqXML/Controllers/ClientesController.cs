...
namespace MvcCoreLinqXML.Controllers
{
    public class ClientesController : Controller
    {
        ...
        /*metodo para insertar un cliente nuevo*/
        ...
        {
            this.repo.AddClient(cliente.IdCliente, cliente.Nombre
                , cliente.Direccion, cliente.Email, cliente.Imagen);
        ...
        {
            this.repo.UpdateCliente(cliente.IdCliente, cliente.Nombre,
                cliente.Direccion, cliente.Email, cliente.Imagen);
            return RedirectToAction("Index");
        }
